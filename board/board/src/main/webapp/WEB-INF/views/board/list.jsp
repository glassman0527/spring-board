...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-2 font-weight-bold text-primary float-left">Board List</h6>
              <a href="register" class="btn btn-warning btn-sm float-right">Register</a>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="get${pageMaker.cri.listLink}&bno=${board.bno}"><c:out value="${board.title}"></c:out></a></td>
  ...
  <script>
  	...
  	// ES6 익명함수를 쓸 때도 이름붙임. 안써도 기능적 오류는 안생김;
